...
/**
 * 	创建模板文件: 根据XML格式文档进行进行创建Excel模板文件
 * @author green
 *
 */
public class CreteTemplate {
	...
	public static void main(String[] args) {
		//获取解析xml文件路径
		String path = System.getProperty("user.dir") + "/src/part2/student.xml";
		//当前工作目录
		...
		try {
			//解析xml文件
			Document parseDocument = builder.build(file);
			//创建Excel
			...
			//获取XML文件根节点
			Element root = parseDocument.getRootElement();
			//获取模板名称
